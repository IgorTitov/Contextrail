---
fileId: contextrail-template:modules:auth:domain:auth-state.d
module: modules/auth
stability: evolving
steward: shared
api: file-local
hexLayer: domain
boundedContext: auth
summary: Auth State.D implementation for the auth module.
owns: Auth State.D implementation within the auth module.
