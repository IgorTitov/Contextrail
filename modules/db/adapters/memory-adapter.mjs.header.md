---
fileId: contextrail-template:modules:db:adapters:memory-adapter
module: modules/db
stability: evolving
steward: shared
api: file-local
hexLayer: adapter
boundedContext: db
summary: "In-process memory adapter for the db module. Ephemeral, lost on restart."
owns: The Memory adapter implementation for the db module.
