---
fileId: contextrail-template:modules:retrieval:ports:embedder-port
...
summary: Embedder port contract for the retrieval module.
owns: The Embedder port interface definition for the retrieval module.
