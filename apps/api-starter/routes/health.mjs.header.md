---
fileId: contextrail-template:apps:api-starter:routes:health
module: apps/api-starter
stability: evolving
steward: shared
api: file-local
summary: Health route handler for the api-starter API.
owns: HTTP handler for the health endpoint in api-starter.
