---
fileId: contextrail-template:apps:react-starter:src:components:Header
module: apps/react-starter
stability: evolving
steward: shared
api: file-local
summary: Header React component for the react-starter app.
owns: The Header UI component and its rendering logic.
