---
fileId: contextrail-template:apps:starter:icons:icon-192.svg
module: apps/starter
stability: evolving
steward: human
api: SVG image asset
owns: The 192x192 app icon visual.
boundaries: Must be a valid SVG. Must not contain embedded scripts or external references. Must remain at 192x192 viewBox for manifest compliance.
...
summary: Icon 192 for the starter app.
---
