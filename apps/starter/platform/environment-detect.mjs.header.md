---
fileId: contextrail-template:apps:starter:platform:environment-detect
module: apps/starter
stability: evolving
steward: shared
api: file-local
summary: Environment Detect for the starter app.
owns: Environment Detect within the starter application.
