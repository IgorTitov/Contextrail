---
fileId: contextrail-template:agents:skills:frontend-delivery:SKILL
module: .agents/skills/frontend-delivery
stability: evolving
steward: shared
api: Codex skill
dependsOn:
...
summary: Implement visible UI slices with explicit accessibility, messages, and selector discipline.
owns: The generated Codex-facing summary for the frontend-delivery workflow module.
...
risks: Manual edits here can fork the frontend-delivery workflow away from the canonical contract.
