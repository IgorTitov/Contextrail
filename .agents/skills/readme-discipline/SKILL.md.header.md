---
fileId: contextrail-template:agents:skills:readme-discipline:SKILL
module: .agents/skills/readme-discipline
stability: evolving
steward: shared
api: Codex skill
dependsOn:
...
summary: Keep folder-level READMEs aligned with real ownership and entrypoints.
owns: The generated Codex-facing summary for the readme-discipline workflow module.
...
risks: Manual edits here can fork the readme-discipline workflow away from the canonical contract.
