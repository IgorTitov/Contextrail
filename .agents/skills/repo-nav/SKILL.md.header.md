---
fileId: contextrail-template:agents:skills:repo-nav:SKILL
module: .agents/skills/repo-nav
stability: evolving
steward: shared
api: Codex skill
dependsOn:
...
summary: Navigate untouched repo areas through headers, public APIs, tests, and nearby docs first.
owns: The generated Codex-facing summary for the repo-nav workflow module.
...
risks: Manual edits here can fork the repo-nav workflow away from the canonical contract.
