---
fileId: contextrail-template:agents:skills:tdd:SKILL
module: .agents/skills/tdd
stability: evolving
steward: shared
api: Codex skill
dependsOn:
...
summary: Start from the smallest failing proof, then implement only what makes it pass.
owns: The generated Codex-facing summary for the tdd workflow module.
...
risks: Manual edits here can fork the tdd workflow away from the canonical contract.
