---
fileId: contextrail-template:agents:skills:control-plane-audit:SKILL
module: .agents/skills/control-plane-audit
stability: evolving
steward: shared
api: Codex skill
dependsOn:
...
summary: Audit drift across instructions, hooks, scripts, docs, and tests, then repair the real source.
owns: The generated Codex-facing summary for the control-plane-audit workflow module.
...
risks: Manual edits here can fork the control-plane-audit workflow away from the canonical contract.
