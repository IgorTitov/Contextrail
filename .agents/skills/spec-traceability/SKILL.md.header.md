---
fileId: contextrail-template:agents:skills:spec-traceability:SKILL
module: .agents/skills/spec-traceability
stability: evolving
steward: shared
api: Codex skill
dependsOn:
...
summary: Keep backlog, PRD, USM, design, and proof references aligned around the changed slice.
owns: The generated Codex-facing summary for the spec-traceability workflow module.
...
risks: Manual edits here can fork the spec-traceability workflow away from the canonical contract.
