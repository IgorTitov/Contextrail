---
fileId: contextrail-template:agents:skills:header-sidecar:SKILL
module: .agents/skills/header-sidecar
stability: evolving
steward: shared
api: Codex skill
dependsOn:
...
summary: Keep structured headers and sidecars aligned with the real file role.
owns: The generated Codex-facing summary for the header-sidecar workflow module.
...
risks: Manual edits here can fork the header-sidecar workflow away from the canonical contract.
